...
predict_data = pd.read_csv('My Submission Logistic 0128.csv')
...
predict_outcome.to_csv(titanDir+'my_submission_v35.csv', index=False)
print("v35 submission was successfully saved - Logistic Regression Azure ML")
